...
import { FaTelegramPlane, FaTwitter, FaInstagram, FaReddit, FaMedium, FaDiscord, FaGithub } from "react-icons/fa";
...
function SocialLinks({ smallIcons }) {
  return (
    <div className={`socialLinks ${smallIcons ? "small" : ""}`}>
      ...
      <a href="https://instagram.com/adademonpage?utm_medium=copy_link">
        <FaInstagram />
      </a>
